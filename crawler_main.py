...
class ZhihuTopic(object):
    ...
    def _parse_child_topic(self):        
        ...
        while continue_load:
            ...
            response_login = ZhihuCommon.get(query_url, post_dict) 
            ...
            [['topic', '学科', '19618774'], [[['load', '显示子话题', '', '19618774'], []]]],
             [['topic', '「未归类」话题', '19776751'], [[['load', '显示子话题', '', '19776751'], []]]],
              [['topic', '「形而ww上」话题', '19778298'], [[['load', '显示子话题', '', '19778298'], []]]]]], 
              'r': 0}
              """
...
class ZhihuCommon(object):
    ...
    my_header = {
        ...
        'Host': 'www.zhihu.com',
        'DNT': '1',
        'Cookie':'d_c0=AHDCeVDrMwuPTl3I_Du2j91cYYzddnTejQc=|1485242799; _zap=300ffef5-1659-4cca-adb0-fb6cc327820f; q_c1=898bc41100ce483a9e1b3859aa2fcd47|1505146430000|1485242799000; capsion_ticket="2|1:0|10:1507109775|14:capsion_ticket|44:NWE5MzE1OTc1YjQzNDgzMDg3ZTQ1YmNmMTQ4OWU2YmM=|571287532a7fdefa94a578d96e3261d7c0d0167fdc3e6189ebec29f1298992f5"; q_c1=898bc41100ce483a9e1b3859aa2fcd47|1507109835000|1485242799000; aliyungf_tc=AQAAAJORYT8wZAcAePpgblgW1ZhbVIb1; anc_cap_id=8912546b813b45f7860f3aaee90c0272; l_cap_id="ZWExMjk2ZTUwYWY4NDlmNThiOTdjZTVlNjIzOThjZTg=|1508765495|59f6f96f0050db461cc1256d0afdea3936cd9963"; r_cap_id="NDVmYzdkOWQ2MDJkNGZhYWIyNjljOTEzYTY1OWE2ODI=|1508765495|e8e35a3c51f4413ce52495b3a5fa32ff5d6b49a5"; cap_id="MzQ0ZThlMDQ4MzU5NDJlY2E4MWMyODc1ZDQ0ZDZiZjc=|1508765495|e5ea5dca057e819894bd74f2aceb26ea35e690da"; __utma=51854390.1795529417.1508329829.1508329998.1508765497.3; __utmb=51854390.0.10.1508765497; __utmc=51854390; __utmz=51854390.1508765497.3.3.utmcsr=baidu|utmccn=(organic)|utmcmd=organic; __utmv=51854390.000--|3=entry_date=20170124=1; z_c0="2|1:0|10:1508765545|4:z_c0|92:Mi4xVDJJSkFnQUFBQUFBY01KNVVPc3pDeWNBQUFDRUFsVk5hWHdWV2dBWTFvSVZsYUFlcGljN1MteUxPRXE0aGZEWjhn|1130cd8671efacad1052e65427a5abefbd32068c3e52b26b53eb975c543b46c9"; _xsrf=2122ba70-9aa1-4c41-9888-a6ae37e4e790; Hm_lvt_9d483e9e48ba1faa0dfceaf6333de846=1508644246,1508645383,1508645426,1508765496; Hm_lpvt_9d483e9e48ba1faa0dfceaf6333de846=1508765549'
    }
    ...
    def post(url, post_dict):
        ...
        while try_time < 5:
            ...
            try:
                try_time += 1
                response = ZhihuCommon.get_session().post(url, headers = ZhihuCommon.my_header, timeout = 30)
                ZhihuCommon._last_get_page_fail = False
                return response
            except Exception as e:
